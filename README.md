...
在任意 Issue 或 PR 下评论 `/weather` 指令，即可获取天气信息回复。
...
- `/weather shanghai`
- `/weather 上海`
- `/weather 31.2304,121.4737` (使用经纬度坐标)

### 功能特点

- 支持中英文城市名称
- 支持经纬度坐标输入
- 显示当前位置、时间、温度、湿度、降水、风速等信息
- 提供未来24小时降雨概率预测
- 无需 API 密钥，使用 Open-Meteo 开源数据
...
📍 位置: 上海, 中国 (31.2304, 121.4737)

🕐 当前时间: 2024年11月16日 17:30
